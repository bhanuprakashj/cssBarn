...
// dev task
gulp.task('dev', gulp.series('clean', 'copyAssets', 'processCss', 'lintHtml', 'lintJs', gulp.parallel('browserSync', 'watchingFiles')));
// build task
gulp.task('build', gulp.series('clean', 'copyAssets', 'processCss', 'lintHtml', 'lintJs'));
